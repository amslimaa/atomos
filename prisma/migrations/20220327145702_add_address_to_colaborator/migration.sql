/*
  ...
  - Added the required column `addressId` to the `colaborator` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_colaborator" ("birth", "clt", "cpf", "created_at", "id", "name") SELECT "birth", "clt", "cpf", "created_at", "id", "name" FROM "colaborator";
